	...
	<div class="login_box">
		...
		<div id="first">
			<form action="register.php" method="POST">
				...
				<br>
				<a href="#" id="signup" class="signup" style="text-decoration: none; color: #e67e22;">Need an account? Register here</a>
		</form>
		</div>
...
<!--Registration form for users-->
	<div id="second">
		<form action="register.php" method="POST">
			...
			?>
			<a href="#" id="signin" class="signin" style="text-decoration: none; color: #e67e22;">Already have an account? Sign-in here</a>
		</form>
	</div>
